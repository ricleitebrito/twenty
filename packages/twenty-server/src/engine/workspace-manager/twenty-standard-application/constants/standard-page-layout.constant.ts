import {
  ...
  STANDARD_COST_TEMPLATE_FIELD_PAGE_LAYOUT_CONFIG,
  STANDARD_COST_TEMPLATE_PAGE_LAYOUT_CONFIG,
  STANDARD_COST_TEMPLATE_STEP_PAGE_LAYOUT_CONFIG,
  ...
  STANDARD_PRODUCT_PAGE_LAYOUT_CONFIG,
  STANDARD_QUOTE_LINE_PAGE_LAYOUT_CONFIG,
  STANDARD_QUOTE_PAGE_LAYOUT_CONFIG,
...
export const STANDARD_PAGE_LAYOUTS = {
  ...
  quoteRecordPage: STANDARD_QUOTE_PAGE_LAYOUT_CONFIG,
  quoteLineRecordPage: STANDARD_QUOTE_LINE_PAGE_LAYOUT_CONFIG,
